...
ssh -p $ssh_port -o StrictHostKeyChecking=no root@$slaveip  "bash <(curl https://raw.githubusercontent.com/vimoshmohan/mysqllab/main/slave_scripts/replication_slave_reset_el8.sh)"
if [[ $(echo $?) -gt 0 ]]; then
